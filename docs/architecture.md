...
•	Location Strategy: Returns Google Maps link + clinic address.
•	Confirmation Strategy: Returns booking time + doctor name.
...
Concurrency	Postgres Realtime: When the secretary adds a patient, the doctor’s dashboard pulses and updates without a refresh.
